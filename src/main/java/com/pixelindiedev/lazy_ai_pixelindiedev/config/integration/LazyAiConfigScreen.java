...
public class LazyAiConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        addDrawableChild(new ButtonWidget(
                ...
                Text.literal("AI Optimization Type: " + config.AIOptimizationType),
                (btn) -> {
        ...
        addDrawableChild(new ButtonWidget(
                width / 2 - 100, y, 200, 20,
                Text.literal("Distance Scaling: " + config.DistanceScaling),
                (btn) -> {
        ...
        addDrawableChild(new ButtonWidget(
                width / 2 - 100, y, 200, 20,
                Text.literal("Mob Tempting Delay: " + config.TemptDelay),
                (btn) -> {
        ...
        addDrawableChild(new ButtonWidget(
                width / 2 - 100, y, 200, 20,
                Text.literal("Disable Zombie Egg Stomping: " + config.DisableZombieEggStomping),
                (btn) -> {
        ...
        addDrawableChild(new ButtonWidget(
                width / 2 - 100, y, 200, 20,
                Text.literal("Enable Vanilla Mob Ticking: " + config.EnableVanillaMobTicking),
                (btn) -> {
